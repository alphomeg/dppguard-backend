...
Revision ID: 8af443966bbe
Revises: 
Create Date: 2025-12-16 21:32:47.972395
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_dppevent_tenant_id'), 'dppevent', ['tenant_id'], unique=False)
    ...
    op.create_index(op.f('ix_dppextradetail_tenant_id'), 'dppextradetail', ['tenant_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_dppextradetail_tenant_id'), table_name='dppextradetail')
    op.drop_index(op.f('ix_dppextradetail_key'), table_name='dppextradetail')
    op.drop_table('dppextradetail')
    op.drop_index(op.f('ix_dppevent_tenant_id'), table_name='dppevent')
